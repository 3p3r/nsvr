...
void BasicClient::CinderPlayer::onError(const gchar* msg) const
{
    std::cerr << "Error received from GStreamer: " << msg << std::endl;
}

void BasicClient::CinderPlayer::onStreamEnd() const
{
...
void BasicClient::CinderPlayer::onState(GstState old) const
{
